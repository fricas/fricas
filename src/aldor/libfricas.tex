...
file \file{src/interp/foam_l.lisp} is also needed.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
If \file{libfricas.al} is built incrementally without intermediate
...
built with srcaldor2 by Peter Broadbery.
