...
It is a list of the main components.  It also contains [[core]]
...
In GCL this link happens through setting a shell variable called
...
This is a string-based hash table that is used both in the graph
