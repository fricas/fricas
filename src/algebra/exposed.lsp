...
(|basic|
  ...
  (|JLComplexF64| . JCF64)
  (|JLDataFrame| . JDFRAME)
  (|JLDrawFunctions| . JDRAW)
  (|JLF64SquareMatrix| . JF64SMAT)
  (|JLF64MatrixTranscendentalFunctions| . JF64MTF)
  (|JLFloat| . JFLOAT)
  (|JLFloat32| . JF32)
  (|JLFloat64| . JF64)
  (|JLFloat64Matrix| . JF64MAT)
  (|JLFloat64SpecialFunctions| . JF64SF)
  (|JLFloat64Vector| . JF64VEC)
  (|JLFloat64VectorFunctions2| . JF64VEC2)
  (|JLFloatSpecialFunctions| . JFSF)
  (|JLInt64| . JI64)
  (|JLInt64Vector| . JI64VEC)
  (|JLMatrix| . JMATRIX)
  (|JLObject| . JOBJECT)
  (|JLObjAnonymousFunction| . JOBANFUN)
  (|JLObjFunction| . JOBFUNC)
  (|JLObjBool| . JOBBOOL)
  (|JLObjBigInt| . JOBBINT)
  (|JLObjDict| . JOBDICT)
  ...
  (|JLF64LinearAlgebra| . JF64LA)
  (|JLStringUtilities| . JSTRU)
  (|JLUtilityFunctions| . JUF)
  (|JLSymbol| . JSYM)
  (|JLVector| . JVECTOR)
  (|JLVectorFunctions2| . JVECTOR2)
  (|WSAPReal| . WSAPR)
  (|WSExpression| . WSEXPR)
  (|WSGaussianInteger| . WSGINT)
  (|WSInteger| . WSINT)
  (|WSList| . WSLIST)
  (|WSMatrix| . WSMAT)
  (|WSNumericalSpecialFunctions| . WSNSF)
  (|WSRational| . WSRAT)
  (|WSReal| . WSREAL)
  (|WSString| . WSSTR)
  (|WSSymbol| . WSSYM)
  (|WSUtilityFunctions| . WSUF)
  (|WSVector| . WSVEC)
  ...
  (|NMArbField| . NARB)
  (|NMExactCalciumField| . NECF)
  (|NMExtendedPadic| . NXPADIC)
  (|NMExtendedQadic| . NXQADIC)
  (|NMExtendedQadicField| . NXQADICF)
  (|NMFactored| . NFR)
  (|NMFiniteField| . NFF)
  (|NMFraction| . NFRAC)
  (|NMInteger| . NINT)
  (|NMIntegerMod| . NZMOD)
  (|NMMultivariateLaurentPolynomial| . NMLP)
  (|NMMultivariatePolynomial| . NMP)
  (|NMPadic| . NPADIC)
  (|NMQadic| . NQADIC)
  (|NMPolynomial| . NPOLY)
  (|NMPrimeField| . NPF)
  (|NMRealBall| . NRB)
  (|NMRealField| . NRF)
  (|NMUnivariateLaurentPolynomial| . NULP)
...
(|categories|
  ...
  (|JLArbitraryPrecision| . JARBPR)
  (|JLCommutativeRing| . JCRING)
  (|JLMachineFloat| . JMFLOAT)
  (|JLMachineType| . JMTYPE)
  (|JLMatrixCategory| . JMATCAT)
  (|JLObjectAggregate| . JOBAGG)
  (|JLObjectType| . JOBJTYP)
  (|JLRing| . JRING)
  (|JLType| . JTYPE)
  (|JLVectorCategory| . JVECCAT)
  (|WSAggregate| . WSAGG)
  (|WSNumber| . WSNUM)
  (|WSObject| . WSO)
  (|WSRing| . WSRING)
  ...
  (|NMCommutativeRing| . NCRING)
  (|NMField| . NFIELD)
  (|NMPadicNumberCategory| . NPADICC)
  (|NMRing| . NRING)
  (|NMType| . NTYPE)
  (|NMUnivariatePolynomialCategory| . NUPC)
...
(|Hidden|
  ...
  (|JLF32ArrayFunctions| . JF32AF)
  (|JLF64ArrayFunctions| . JF64AF)
  (|JLCF32LinearAlgebra| . JCF32LA)
  (|JLCF64LinearAlgebra| . JCF64LA)
  (|JLComplexF32| . JCF32)
  (|JLComplexF32Matrix| . JCF32MAT)
  (|JLComplexF32SquareMatrix| . JCF32SMA)
  (|JLComplexF32Vector| . JCF32VEC)
  (|JLComplexF64Matrix| . JCF64MAT)
  (|JLComplexF64MatrixTranscendentalFunctions| . JCF64MTF)
  (|JLComplexF64SquareMatrix| . JCF64SMA)
  (|JLComplexF64Vector| . JCF64VEC)
  (|JLComplexFloat| . JCFLOAT)
  (|JLComplexFloatSpecialFunctions| . JCFSF)
  (|JLF32LinearAlgebra| . JF32LA)
  (|JLFloat32Matrix| . JF32MAT)
  (|JLFloat32SpecialFunctions| . JF32SF)
  (|JLFloat32SquareMatrix| . JF32SMAT)
  (|JLFloat32Vector| . JF32VEC)
  (|JLFloat32VectorFunctions2| . JF32VEC2)
  (|JLFloat32SpecialFunctions2| . JF32SF2)
  (|JLFloat64SpecialFunctions2| . JF64SF2)
  (|JLFloatSpecialFunctions2| . JFSF2)
  (|JLObjComplexF32| . JOBCF32)
  (|JLObjComplexF64| . JOBCF64)
  (|JLObjUInt64| . JOBUI64)
  (|Kernel| . KERNEL)
  (|Kovacic| . KOVACIC)
