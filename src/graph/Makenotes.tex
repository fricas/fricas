...
version23: (first version after returning from Europe)
   ...
   tube.c: changed crossedLines() to generalPartialSplit() - an algorithm
...
version24: view3D/tube.c: put in calculations for xmin,xmax,ymin,ymax
   ...
   function of 2 variables now has its own substructure, like tube, and
   ...
   then view2D and view3D will use a predefined default set of fonts. if that
...
version25:
  ...
  BUG FIXED: this time, for sure. flipped quadrants II and IV to remedy bug
