...
**JLF32ArrayFunctions is a package constructor**  
**Abbreviation for JLF32ArrayFunctions is JF32AF**  
...
- **Signature**: `(String,JLComplexF32Vector)->JLFloat32`

jlApplyFunction(func, cvec, p) returns the output value of func applied to cvec with parameter p.

- **Signature**: `(String,JLComplexF32Vector,JLFloat32)->JLFloat32`
...
- **Signature**: `(String,JLComplexF32Vector,NonNegativeInteger)->JLFloat32`
...
- **Signature**: `(String,JLComplexF32Vector,NonNegativeInteger,JLFloat32)->JLFloat32`

jlApplyFunction(func, vec) returns the output value of func applied to vec.

- **Signature**: `(String,JLFloat32Vector)->JLFloat32`

jlApplyFunction(func, vec, p) returns the output value of func applied to vec with parameter p.

- **Signature**: `(String,JLFloat32Vector,JLFloat32)->JLFloat32`
...
- **Signature**: `(String,JLFloat32Vector,NonNegativeInteger)->JLFloat32`
...
- **Signature**: `(String,JLFloat32Vector,NonNegativeInteger,JLFloat32)->JLFloat32`

jlApplyFunction(func, vec) applies func to cvec.

- **Signature**: `(String,JLComplexF32Vector)->Void`

jlApplyFunction(func, cmat, nr) applies func to the matrix mat, internally a vector, where the numer of rows is nr.

- **Signature**: `(String,JLComplexF32Vector,NonNegativeInteger)->Void`

jlApplyFunction(func, vec) applies func to vec.

- **Signature**: `(String,JLFloat32Vector)->Void`
...
- **Signature**: `(String,JLComplexF32Vector,JLComplexF32Vector)->Void`
...
- **Signature**: `(String,JLComplexF32Vector,JLComplexF32Vector,NonNegativeInteger)->Void`
...
- **Signature**: `(String,JLComplexF32Vector,JLFloat32Vector,NonNegativeInteger)->Void`
...
- **Signature**: `(String,JLComplexF32Vector,NonNegativeInteger,JLComplexF32Vector,NonNegativeInteger)->Void`
...
- **Signature**: `(String,JLFloat32Vector,JLComplexF32Vector,NonNegativeInteger)->Void`
...
- **Signature**: `(String,JLFloat32Vector,JLFloat32Vector)->Void`
...
- **Signature**: `(String,JLFloat32Vector,JLFloat32Vector,NonNegativeInteger)->Void`
...
- **Signature**: `(String,JLFloat32Vector,NonNegativeInteger,JLFloat32Vector,NonNegativeInteger)->Void`
---
